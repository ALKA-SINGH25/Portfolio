        ...
        {open && (
          ...
          >
            ...
            <div onClick={() => isMobile() && setOpen(false)}>
              <a
                href="/Alka_Kumari_Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="block text-center bg-black text-white py-2 px-4 rounded-md text-sm hover:opacity-80 transition"
              >
                Read Resume
              </a>
            </div>
...
/>
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Alka Kumari</p>
